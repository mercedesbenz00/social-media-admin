<template>
  <div class="text-sm gap-y-6 flex flex-col" :class="options.center ? ' items-center' : 'w-full items-start'">
    <PButton
      v-if="options.onNext"
      icon-pos="right"
    ...
    <PButton
      ...
      class="text-sm font-bold btn-flat-primary"
